  ...
  return (
    <>
      ...
      <div className={styles.featured_products}>
        <h2 className={styles.featured_products_title}>Featured Products</h2>
      ...
      <div className={styles.about}>
        ...
        <div className={styles.about_right}>
          ...
          What makes “Claymore” marketplace unique is that it is built on the
          foundation of blockchain technology, which provides an unalterable and
          trustless ledger that ensures the security and authenticity of all
          transactions. With Claymore, buyers and sellers can rest assured that
          they are dealing with a platform that is immune to hacking, fraud, or
      ...
      <div className={styles.benefits}>
        <h2 className={styles.benefits_title}>Benefits of using Claymore</h2>
        <p className={styles.red_line}></p>
        <div className={styles.benefits_container}>
          <div className={styles.benefits_left}>
            ...
            <div className={styles.benefits_card}>
              ...
              Claymore is not just secure, it is also user-friendly.
            </div>
            <div className={styles.benefits_card}>
              <div className={styles.circle_number}>02</div>
              We have created a vibrant ecosystem of buyers, sellers, and
              service providers.
            </div>
            <div className={styles.benefits_card}>
              <div className={styles.circle_number}>02</div>
